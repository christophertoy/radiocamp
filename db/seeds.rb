...
Broadcaster.create(handle: 'sound-on', name: 'Sound-On Network', description: 'Beneath the underground, there is another sound. News and music from the latest innovators.', theme: 'themePurpleYellow', logo: 'https://images.unsplash.com/photo-1506704888326-3b8834edb40a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80')
Broadcaster.create(handle: 'tcn', name: 'The Cooking Network', description: 'All cooking. All the time.', theme: 'themeTeal', logo: 'https://images.unsplash.com/photo-1507048331197-7d4ac70811cf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80')
...
Episode.create(title: "Channel Orange", description: "We examine the landmark album from Frank Ocean. How has it influenced the genre 8 years later?", release_date: "2020-07-10", episode_url: "", show_id: 9, episode_number: 12, image: "https://images.unsplash.com/photo-1517816428104-797678c7cf0c")
...
(1..100).each do
  Episode.create(
    ...
    show_id: random.rand(5..Show.count),
