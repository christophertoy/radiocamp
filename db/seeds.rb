...
Broadcaster.create(handle: 'nhs', name: 'New Huffington Syndicate', description: 'Unique perspectives from around the globe.', theme: 'themePurpleYellow', logo: 'https://images.unsplash.com/photo-1595535916132-0dfbd3a6577c')
