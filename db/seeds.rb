...
Broadcaster.create(handle: 'kbbl', name: 'KBBL 102.5FM', description: 'Beneath the underground, there is another sound. News and music from the latest innovators.', theme: 'themePurpleYellow', logo: 'https://images.unsplash.com/photo-1506704888326-3b8834edb40a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80')
